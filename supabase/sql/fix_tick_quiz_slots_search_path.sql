-- ============================================================
-- Fix security warnings for tick_quiz_slots function
...
BEGIN
  -- ========================================
  -- STEP A: Create quizzes 5 minutes before start
  -- ========================================
  FOR rec IN
    SELECT s.*
    FROM quiz_slots s
  ...
  -- ========================================
  -- STEP E: Auto-delete old quizzes (4 days old)
  -- ========================================

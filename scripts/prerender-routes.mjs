 ...
 */
const ROUTES = [
  { path: '/', title: 'Quiz Dangal â€“ Daily Opinion & GK Quiz for IPL Fans', description: "Quiz Dangal is India\u2019s daily opinion and GK quiz arena. Play IPL season polls, current affairs rounds, and general knowledge quizzes, grow streaks, invite friends, and redeem rewards.", robots: 'index, follow' },
  { path: '/leaderboards/', title: 'Leaderboards â€“ Quiz Dangal | Top Quiz Players', description: 'See the top players on Quiz Dangal leaderboards. Compete in daily opinion and knowledge quizzes, win coins, and climb ranks.' },
  { path: '/play-win-quiz-app/', title: 'Play & Win â€“ Quiz Dangal | How It Works', description: 'Play daily quizzes, climb leaderboards, and win rewards. Opinion-based and GK quizzes made for India â€“ start free on Quiz Dangal.' },
  { path: '/opinion-quiz-app/', title: 'Opinion Quiz â€“ Quiz Dangal | Fun & Fast Rounds', description: 'Try quick, low-pressure opinion quizzes on Quiz Dangal. Share your take, compare with others, and earn coins as you play.' },
  { path: '/refer-earn-quiz-app/', title: 'Refer & Earn â€“ Quiz Dangal | Invite Friends, Get Coins', description: 'Invite friends to Quiz Dangal and earn bonus coins when they join and play opinion-based and GK quizzes.' },
  { path: '/gk-quiz/', title: 'GK Quiz â€“ Quiz Dangal', description: 'Play a GK quiz daily and sharpen your general knowledge. Compete, earn coins, and climb the leaderboards.' },
  { path: '/cricket-quiz/', title: 'Cricket Quiz Online â€“ Quiz Dangal | IPL & World Cup Trivia', description: 'Play the best cricket quiz online. Test your IPL, World Cup, and cricket trivia knowledge daily on Quiz Dangal.' },
  { path: '/current-affairs-quiz/', title: 'Current Affairs Quiz â€“ Quiz Dangal | Daily GK for Exams', description: 'Daily current affairs quiz for UPSC, SSC, and bank exam prep. Stay updated and earn coins on Quiz Dangal.' },
  { path: '/bollywood-quiz/', title: 'Bollywood Quiz â€“ Quiz Dangal | Movie & Celebrity Trivia', description: 'Play Bollywood quiz rounds covering iconic movies, songs, and celebrity trivia. New questions daily on Quiz Dangal.' },
  { path: '/about-us/', title: 'About Us â€“ Quiz Dangal', description: 'Quiz Dangal â€“ India\u2019s most exciting quiz and rewards platform where knowledge meets entertainment.' },
  { path: '/contact-us/', title: 'Contact Us â€“ Quiz Dangal', description: 'Get in touch with the Quiz Dangal team for support, partnership, or feedback.' },
  { path: '/terms-conditions/', title: 'Terms & Conditions â€“ Quiz Dangal', description: "Read Quiz Dangal\u2019s terms and conditions." },
  { path: '/privacy-policy/', title: 'Privacy Policy â€“ Quiz Dangal', description: 'Learn how Quiz Dangal collects and protects your data.' },
  { path: '/category/opinion/', title: 'Opinion Quizzes â€“ Quiz Dangal', description: 'Play opinion-based quizzes. Share your take, compare with others, and earn coins as you play.' },
  { path: '/category/gk/', title: 'GK Quizzes â€“ Quiz Dangal', description: 'Sharpen your general knowledge with live and upcoming GK quizzes on Quiz Dangal.' },
];

...
export default function IndiaQuiz() {
  return (
    <SeoLanding
      ...
      keywords={['india quiz', 'online quiz', 'quiz app', 'gk quiz', 'hindi quiz']}
      relatedLinks={[
        { href: '/', label: 'Home' },
      ...
      faqs={[
        {
          question: 'Is Quiz Dangal for Indian audiences?',
          answer: 'Yes. Our quizzes, rewards-style coins, and categories are designed for India-first gameplay.',
        },
      ]}
    />
  );
